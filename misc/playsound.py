...
def draw_text(speed):
    ...
    display.text(f"SPEED: {text}", 3, 3, 200, 3)
...
def playsong(song):                 # this function plays your song
    ...
    for i in range(len(song)):
        ...
        draw_text(sleep_s)
        display.update()
        time.sleep(sleep_s)  # change this number if you want to alter how long the notes play for
    bequiet()
